...
This project is a full-stack application utilising React for the frontend, Java for the backend, and AWS services for deployment and authentication. The system is designed to provide a seamless and scalable experience, leveraging AWS Lambda, Cognito, S3, and Elastic Beanstalk
...
* **Google Drive**
  Google Drive was used to store and share project-related documentation, such as meeting notes, planning documents, and research papers. Its shared access and organisational features supported team transparency and efficient document management.
